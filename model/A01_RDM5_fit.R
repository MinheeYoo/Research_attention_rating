...
# stan_model = stan_model("RDM5.stan")
# saveRDS(stan_model, "RDM5_compiled.RData")
stan_model = readRDS("RDM5_compiled.RData")
...
save(dataList, data_wide, file = "RDM5_hier_data.RData")
saveRDS(model_obj, "RDM5_hier_fit.RData")
