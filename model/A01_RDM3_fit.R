...
# stan_model = stan_model("RDM3.stan")
# saveRDS(stan_model, "RDM3_compiled.RData")
stan_model = readRDS("RDM3_compiled.RData")
...
save(dataList, data_wide, file = "RDM3_hier_data.RData")
saveRDS(model_obj, "RDM3_hier_fit.RData")
