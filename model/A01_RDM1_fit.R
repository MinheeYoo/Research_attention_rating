...
# stan_model = stan_model("RDM1.stan")
# saveRDS(stan_model, "RDM1_compiled.RData")
stan_model = readRDS("RDM1_compiled.RData")
...
save(dataList, data_wide, file = "RDM1_hier_data.RData")
saveRDS(model_obj, "RDM1_hier_fit.RData")
