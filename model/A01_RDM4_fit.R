...
# stan_model = stan_model("RDM4.stan")
# saveRDS(stan_model, "RDM4_compiled.RData")
stan_model = readRDS("RDM4_compiled.RData")
...
save(dataList, data_wide, file = "RDM4_hier_data.RData")
saveRDS(model_obj, "RDM4_hier_fit.RData")
